#!/usr/bin/env python3
"""
Convert backend/resources/unsubscribed.jsonl from pseudo-JSON (single quotes,
list-per-line) into proper JSONL (one JSON object per line), deduped on
...
SRC = ROOT / "resources" / "unsubscribed.jsonl"
DST = ROOT / "resources" / "unsubscribed_clean.jsonl"
