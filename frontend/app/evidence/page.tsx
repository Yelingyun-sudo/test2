...
const EvidenceDashboard = dynamic(
  () =>
    import("@/components/dashboard/evidence-dashboard").then((mod) => mod.EvidenceDashboard),
  { ssr: false }
);
...
export default function EvidencePage() {
  ...
  return (
    <EvidenceDashboard onLogout={handleLogout} account={account ?? undefined} />
  );
}
