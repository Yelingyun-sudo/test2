...
export type TaskStatus = "PENDING" | "RUNNING" | "RETRYING" | "SUCCESS" | "FAILED";
...
export const STATUS_STYLES: Record<TaskStatus, string> = {
  ...
  RETRYING: "bg-orange-50 text-orange-600 border border-orange-200",
...
export const STATUS_COLORS_ENHANCED: Record<TaskStatus, string> = {
  ...
  RETRYING: "#fb923c",     // 更柔和的橙色（orange-400）
